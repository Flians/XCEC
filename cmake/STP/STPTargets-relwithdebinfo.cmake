...
set_target_properties(stp PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/XECE/lib/macos/libstp.2.3.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libstp.2.3.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS stp )
list(APPEND _IMPORT_CHECK_FILES_FOR_stp "${_IMPORT_PREFIX}/XECE/lib/macos/libstp.2.3.dylib" )
